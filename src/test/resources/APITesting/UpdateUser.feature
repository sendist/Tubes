Feature: Update User
  ...
  @OperationHasValidAuthorizationAndUpdatesLastName @TC06
  Scenario: Operation has valid authorization and updates last name
    Given prepare JSON payload with "TC06"
